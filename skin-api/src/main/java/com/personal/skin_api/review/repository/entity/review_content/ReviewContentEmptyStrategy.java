...
public class ReviewContentEmptyStrategy implements ReviewContentValidationStrategy {

    @Override
    public void validate(final String reviewContent) {
        if (reviewContent.isEmpty() || reviewContent.isBlank())
            throw new RestApiException(ReviewContentErrorCode.REVIEW_CONTENT_CAN_NOT_BE_EMPTY);
    }
}
